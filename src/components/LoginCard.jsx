    ...
    return (
        <div className='flex flex-col justify-center w-[400px]'>
            <form className='w-full mx-auto rounded-lg bg-white p-8 px-8 h-[500px]'>
                ...
                <button className='w-full mt-10 py-2 bg-orange-alta shadow-lg text-white font-semibold rounded-lg'>LOGIN</button>
...
export default LoginCard
    // < section class="bg-gray-50 min-h-screeify-cenn flex items-center justter" >
